...
<li><a href='picture.html'>Galery</a></li>
  <li> <a href='page6-VieAllMembersReverse.jsp'>view all members</a></li>
  <li> <a href='page5-SearchMemberLike.jsp'>search by last name</a></li>
<li><a href='page1-View-AllMembers-Choose-to-Update.jsp'>update and delete members</a></li>
</ul>
<br></br>
...
if (session.getAttribute("Status")!= null &&  session.getAttribute("Status") == "admin")
{
	out.print("</div>");
	out.print("<br></br>");
	out.print("<h1>סוגי מנויים במחירים מוזלים לחברים</h1>");
	out.print("<br></br>");
	...
	out.print("<div class='overlay'>מנוי שנתי 2000 שקלים</div>");
	out.print("</div>");
	out.print("</td>");
	out.print("<td>");
	out.print("<div class='container'>");
	out.print( "<img src='mj.jpg' alt='Avatar' class='image'>");
	out.print( "<div class='overlay'>מנוי קיץ 1250 שקלים</div>");
	out.print("</div>");
	out.print("</td>");
	out.print("<td>");
	out.print("<div class='container'>");
	out.print(  "<img src='mj.jpg' alt='Avatar' class='image'>");
	out.print(  "<div class='overlay'>מנוי חודשי 140 שקלים</div>");
	out.print("</div>");
	out.print("</tr>");
	out.print("<tr>");
